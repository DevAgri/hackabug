<template>
  <div id="Cultura" class="black--text">
...
export default {
  ...
  created () {
    this.service = new CulturaService(this.$http)
    this.service.load()
    .then(function (res) {
      console.log(res)
      this.items = res
  ...
  methods: {
    ...
    adiciona () {
      this.isBusy = true
      this.service.add(this.nomeCultura)
      .then(function (res) {
        this.warningMessage = 'Cultura Adicionada com sucesso'
        this.nomeCultura = ''
        this.service.load()
        .then(function (res) {
          console.log(res)
    ...
    removeSelecionados () {
      this.selected.forEach(function (element) {
        ...
        .then(function (res) {
          ...
          console.log(err)
          this.warningMessage = 'Houve um erro ao excluir a(s) cultura(s)'
        })
      }, this)
    }
  }
